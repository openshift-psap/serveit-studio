...
- Latency SLA: none
- Calibrated load: yes
- Concurrency sweep: yes — tests the top 4 recommendation configs (Best Balanced, Lowest TTFT, Highest Throughput, Most Efficient) across 8 stress scenarios from light to heavy load, mapping how each config handles increasing traffic
- EPP tuned sweep: yes
- Cache sweep: no
