"""
In-S8 Optimization Report Generator — backward-compatibility facade.
...
def generate_html_report(db_path: str = '/mnt/storage/in-s8.db',
...
def generate_markdown_report(db_path: str = '/mnt/storage/in-s8.db',
