    ...
    if (rec && rec.best_by_percentile && rec.best_by_percentile.p90) {
        ...
        if (_anyArch) {
            ...
            _archDefs.forEach(function(arch) {
                ...
                secCfg += '<div style="width:760px;margin:0 auto;font-weight:700;font-size:0.85em;color:' + arch.color + ';text-transform:uppercase;letter-spacing:0.06em;border-bottom:2px solid ' + arch.color + ';padding-bottom:4px;margin-bottom:6px;text-align:center;">' + arch.label + ' Architecture</div>';
                secCfg += '<table style="font-size:0.83em;border-collapse:collapse;table-layout:fixed;width:760px;margin:0 auto;">';
