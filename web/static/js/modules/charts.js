    ...
    if (rec && rec.best_by_percentile && rec.best_by_percentile.p90) {
        ...
        if (_anyArch) {
            ...
            _archDefs.forEach(function(arch) {
                ...
                secCfg += '<div style="flex:1;min-width:0;">';
                secCfg += '<div style="font-weight:700;font-size:0.82em;color:' + arch.color + ';text-transform:uppercase;letter-spacing:0.05em;border-bottom:2px solid ' + arch.color + ';padding-bottom:3px;margin-bottom:6px;text-align:center;">' + arch.label + ' Architecture</div>';
