...
DB_PATH = '/mnt/storage/serveit.db'
...
def main():
    ...
    if config_json_str:
        ...
        print("  ✅ Restored exact config from config_json")
    else:
        ...
        recipe_config = RecipeOptimizerConfig(
            ...
            image='ghcr.io/llm-d/llm-d-cuda:v0.5.1', pvc_name='serveit-model-cache',
        ...
        print("  ⚠️  No config_json found, reconstructed from DB columns")
